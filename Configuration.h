...
#define STRING_CONFIG_H_AUTHOR "(HOME MADE)" 
...
#define DELTA_DIAGONAL_ROD 218.4 // mm

// Horizontal offset from middle of printer to smooth rod center.
#define DELTA_SMOOTH_ROD_OFFSET 159.4 // mm

// Horizontal offset of the universal joints on the end effector.
#define DELTA_EFFECTOR_OFFSET 26.6 // mm

// Horizontal offset of the universal joints on the carriages.
#define DELTA_CARRIAGE_OFFSET 30.6 // mm
...
#define Z_HOME_DIR 1
//软限位开关设置
#define min_software_endstops true //jss.. kossel=true...jss// If true, axis won't move to coordinates less than HOME_POS.
...
#define MANUAL_Z_HOME_POS 288.0 //288.9-1.5//290-1.1//300-12//306.6 // Z轴高度设置
